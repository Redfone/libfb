 ...
 *  @file sha1.c
 *
 *  @brief SHA1 reference implementation 
 *
 *  @details Description:
...
/**
 *  @brief This function will initialize the SHA1Context in
...
/**
 * @brief This function will return the 160-bit message digest into
 * the Message_Digest array provided by the caller.  
 *
 * @attention The first octet of hash is stored in the 0th element,
 ...
 * @param message_array An array of characters representing the next
